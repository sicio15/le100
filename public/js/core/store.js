...
function loadCache() {
  try {
    ...
    if (s) {
      ...
      out.weekTower = Math.max(1, +s.weekTower || 1);
      out.weekClaimedKey = +s.weekClaimedKey || 0;
      return out;
    }
  } catch (e) {}
...
// ===== RESET SEMANAL + HITOS DE TORRE =====
const weekNow = () => Math.floor(Date.now() / 604800000);
function checkWeekReset() {
  if ((S.weekClaimedKey || 0) > 0 && S.weekClaimedKey !== weekNow()) {
    // nueva semana: se mantiene weekClaimedKey viejo (marca "no reclamé esta semana")
  }
